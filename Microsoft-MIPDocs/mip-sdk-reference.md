...
[mip::EileEngine](class_mip_fileengine.md) | Interfaccia per tutte le funzioni del motore.
...
[mip::PrivilegedRequiredError](class_mip_privilegedrequirederror.md) | L'etichetta corrente è stata impostata dal metodo di assegnazione con privilegi e l'override non è possibile.
