...
## <a name="summary"></a>Riepilogo
 Membri                        | Descrizioni                                
--------------------------------|---------------------------------------------
public bool AccessCheck | Controlla se il criterio concede all'utente l'accesso al diritto specificato.
...
public std::shared_ptr< TemplateDescriptor > GetTemplateDescriptor public std::shared_ptr< PolicyDescriptor > GetPolicyDescriptor public std::string GetOwner | Ottiene l'indirizzo e-mail del proprietario del contenuto.
