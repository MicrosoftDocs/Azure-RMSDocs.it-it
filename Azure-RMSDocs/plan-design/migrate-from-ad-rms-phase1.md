...
description: Fase 1 della migrazione da AD RMS ad Azure Rights Management (Azure RMS) che illustra i passaggi da 1 a 4 della migrazione da AD RMS ad Azure Rights Management.
author: cabailey
manager: mbaldwin
ms.date: 08/25/2016
ms.topic: article
