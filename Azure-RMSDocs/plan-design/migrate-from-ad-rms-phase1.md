...
## <a name="step-1-download-the-azure-rights-management-administration-tool"></a>Passaggio 1: Scaricare Azure Rights Management Administration Tool
...
## <a name="step-2-export-configuration-data-from-ad-rms-and-import-it-to-azure-information-protection"></a>Passaggio 2: Esportare i dati di configurazione da AD RMS e importarli in Azure Information Protection
...
## <a name="step-3-activate-your-azure-information-protection-tenant"></a>Passaggio 3. Attivare il tenant di Azure Information Protection
...
## <a name="step-4-configure-imported-templates"></a>Passaggio 4. Configurare i modelli importati
