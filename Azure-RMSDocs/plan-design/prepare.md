...
- **Per l'assegnazione di etichette agli utenti** quando si usano l'assegnazione di etichette e la classificazione. Solo gli amministratori possono selezionare questi gruppi:
...
Dopo aver verificato che gli utenti e i gruppi sono utilizzabili con Azure Information Protection e che tutto è pronto per iniziare ad applicare la protezione a documenti e messaggi di posta elettronica, attivare il servizio Rights Management per abilitare il servizio di protezione dati. Per altre informazioni, vedere [Attivazione di Azure Rights Management](../deploy-use/activate-service.md).
