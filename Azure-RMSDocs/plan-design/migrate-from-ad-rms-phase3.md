...
description: Fase 3 della migrazione da AD RMS ad Azure Rights Management (Azure RMS) che illustra i passaggi 6 e 7 della migrazione da AD RMS ad Azure Rights Management.
author: cabailey
manager: mbaldwin
ms.date: 08/17/2016
ms.topic: article
