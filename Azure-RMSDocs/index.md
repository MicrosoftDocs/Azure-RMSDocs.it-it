...
ms.locfileid: "29772976"
---
# <a name="azure-information-protection-documentation"></a>Documentazione di Azure Information Protection

Controllo e protezione di messaggi di posta elettronica, documenti e dati sensibili che vengono condivisi fuori dall'azienda. Dalla classificazione semplice alle etichette e alle autorizzazioni incorporate, la protezione dei dati viene ottimizzata in tutte le fasi con Azure Information Protection, indipendentemente da dove sono archiviati i dati e da come e con chi vengono condivisi.
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Sessioni su Azure Information Protection tratte da Microsoft Ignite 2016</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Altre informazioni su Azure Information Protection</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Esercitazione introduttiva</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Guida di orientamento per la distribuzione</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Installazione del client </h3>
                    </div>
                </div>
            </div>
        </div>
    ...
    <li>
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    <div class="cardText">
                        <p><a href="/information-protection/develop/developers-guide">Guida per gli sviluppatori</a></p>
                    </div>
                </div>
            </div>
        </div>
