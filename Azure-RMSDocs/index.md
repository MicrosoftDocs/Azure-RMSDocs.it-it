...
<article id="main">
    <section id="hero-content">
      ...
      <h2>Qui è disponibile tutto ciò che serve sapere per distribuire e gestire Azure Rights Management (Azure RMS). La documentazione illustra come iniziare a usare Azure RMS per applicare la protezione delle informazioni alla posta elettronica, ai documenti e ad altri dati sensibili.</h2>
