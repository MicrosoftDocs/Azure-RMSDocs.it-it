...
|Richiedere una nuova funzionalità o modifica di funzionalità|Vedere il sito [UserVoice](https://office365.uservoice.com/forums/928576-microsoft-information-protection-mip) per Azure Information Protection e usare l'indirizzo di posta elettronica aziendale per accedere.|
...
Per informazioni sulle versioni nuove e di anteprima, vedere la pagina relativa alla cronologia delle versioni [client-versione e ai criteri di supporto di Azure Information Protection Unified Labeling](rms-client/unifiedlabelingclient-version-release-history.md).
...
|**Azure Information Protection e una sottoscrizione di Microsoft 365**<br /><br />**Azure Rights Management con una sottoscrizione di Microsoft 365**|Vedere [Contattare il supporto per i prodotti per le aziende - Guida per gli amministratori](https://support.office.com/article/32a17ca7-6fa0-4870-8a8d-e25ba4ccfd4b) per informazioni su come contattare il supporto tramite il portale di amministrazione di Microsoft 365 e per i numeri di telefono di contatto.|
...
|**Azure Information Protection con Microsoft 365 Enterprise**|Usare i [canali di supporto Microsoft 365](https://support.office.com/article/32a17ca7-6fa0-4870-8a8d-e25ba4ccfd4b).|
| | |
...
- [Sessioni registrate da Microsoft Ignite](what-is-information-protection.md#additional-resources)
...
- In caso di domande su un'istruzione di supporto per Azure Information Protection: vedere le informazioni sui [requisiti](requirements.md) .
...
- Per il client di Azure Information Protection, vedere la sezione [controlli e risoluzione dei problemi di installazione](./rms-client/clientv2-admin-guide.md#installation-checks-and-troubleshooting) nella Guida dell'amministratore del client e confermare che si sta usando una [versione supportata](./rms-client/unifiedlabelingclient-version-release-history.md#servicing-information-and-timelines). 

    Se è disponibile una versione di anteprima, provare a verificare se il problema è stato risolto: non tutte le correzioni sono elencate nella cronologia delle versioni.
