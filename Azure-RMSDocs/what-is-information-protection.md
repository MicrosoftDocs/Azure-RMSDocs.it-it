...
description: Azure Information Protection (AIP) è un servizio che consente alle organizzazioni di assegnare etichette a documenti e messaggi di posta elettronica. AIP classifica e protegge i dati, indipendentemente dalla posizione in cui vengono salvati.
author: batamig
ms.author: bagol
manager: rkarlin
ms.date: 10/18/2020
...
ms.locfileid: "92163742"
---
# <a name="what-is-azure-information-protection"></a>Che cos'è Azure Information Protection?

>*Si applica a: [Azure Information Protection](https://azure.microsoft.com/pricing/details/information-protection)*

Azure Information Protection è una soluzione basata sul cloud che consente alle organizzazioni di classificare e proteggere documenti e messaggi di posta elettronica mediante l'applicazione di etichette. Le etichette possono essere applicate:

- **Automaticamente** dagli amministratori tramite regole e condizioni
- **Manualmente** dagli utenti
- **Tramite una combinazione di entrambi i metodi** in cui gli amministratori definiscono le raccomandazioni visualizzate agli utenti
...
Usare Azure Information Protection per applicare etichette di classificazione a documenti e messaggi di posta elettronica.
...
Azure RMS è integrato con altri servizi e applicazioni cloud Microsoft, ad esempio Microsoft 365 e Azure Active Directory, e può essere usato anche con le proprie applicazioni o applicazioni di terze parti e soluzioni di protezione delle informazioni. Azure RMS funziona con soluzioni sia locali che cloud.
...
:::image type="content" source="media/templates-exchangeonline-callouts.png" alt-text="Piè di pagina e intestazioni del messaggio di posta elettronica di esempio che mostrano la classificazione di Azure Information Protection":::
...
:::image type="content" source="media/right-click-classify-protect-folder.png" alt-text="Piè di pagina e intestazioni del messaggio di posta elettronica di esempio che mostrano la classificazione di Azure Information Protection":::
...
Ad esempio, potrebbe essere necessario inviare informazioni riservate a indirizzi di posta elettronica personali che usano un account **Gmail** , **Hotmail** o **Microsoft** o a utenti che non hanno un account in Microsoft 365 o Azure AD. Questi messaggi di posta elettronica deve essere crittografati sia nella posizione di archiviazione che in transito e devono essere letti solo dai destinatari originali.
...
:::image type="content" source="media/ome-message.png" alt-text="Piè di pagina e intestazioni del messaggio di posta elettronica di esempio che mostrano la classificazione di Azure Information Protection":::
...
- [Novità dell'interfaccia di amministrazione di Microsoft 365](/microsoft-365/admin/whats-new-in-preview)
- [Novità dell'interfaccia di amministrazione di SharePoint](/sharepoint/what-s-new-in-admin-center)
...
- **Feed di Twitter per Docs:** [https://twitter.com/docsmsft](https://twitter.com/docsmsft)

**Risorse aggiuntive:** [Informazioni e supporto per Azure Information Protection](information-support.md)

### <a name="microsoft-ignite"></a>Microsoft Ignite

Microsoft Ignite 2020 è stato tenuto in remoto ed è stato un grande successo. Le registrazioni delle sessioni sono disponibili all'indirizzo [https://myignite.microsoft.com/sessions](https://myignite.microsoft.com/sessions).
...
> [!TIP]
> Per informazioni su Microsoft Ignite 2019 in Orlando, vedere il riepilogo nel blog: [Microsoft Information Protection - Ignite 2019 recap](https://techcommunity.microsoft.com/t5/microsoft-security-and/microsoft-information-protection-ignite-2019-recap/ba-p/998174) (Microsoft Information Protection - Riepilogo di Ignite 2019)
> 
