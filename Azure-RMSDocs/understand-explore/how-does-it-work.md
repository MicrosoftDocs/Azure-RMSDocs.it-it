...
- Se i clienti scelgono di usare la chiave BYOK (Bring Your Own Key) con Azure Key Vault. Azure Information Protection supporta lunghezze della chiave di 1024 bit e 2048 bit. Per una maggiore sicurezza, si consiglia una lunghezza della chiave di 2048 bit.
...
**Cosa avviene nel passaggio 3**: infine, il client RMS incorpora i criteri in un file con il corpo del documento crittografato in precedenza e insieme costituiscono un documento protetto.
