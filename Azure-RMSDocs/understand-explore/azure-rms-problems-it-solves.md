...
description: Usare la seguente tabella per identificare i requisiti aziendali e i possibili problemi dell'organizzazione e per scoprire la soluzione fornita da Azure RMS.
author: cabailey
manager: mbaldwin
ms.date: 07/13/2016
ms.topic: article
