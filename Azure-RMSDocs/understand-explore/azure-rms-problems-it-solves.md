...
> [!TIP]
> Gli utenti che hanno già acquisito familiarità con la versione locale di Rights Management e Active Directory Rights Management Services (AD RMS), possono essere interessati alla tabella comparativa disponibile in [Confronto tra Azure Rights Management e AD RMS](compare-azure-rms-ad-rms.md).
...
Per altre informazioni su queste certificazioni esterne, vedere il [Centro protezione di Azure](http://azure.microsoft.com/support/trust-center/compliance/).
