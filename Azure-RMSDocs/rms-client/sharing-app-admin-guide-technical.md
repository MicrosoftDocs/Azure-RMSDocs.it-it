...
description: "L'applicazione di condivisione Microsoft Rights Management è un'applicazione facoltativa scaricabile per Microsoft Windows e altre piattaforme e che fornisce le operazioni seguenti."
author: cabailey
manager: mbaldwin
ms.date: 07/15/2016
ms.topic: article
...
# Panoramica tecnica e dettagli sulla protezione per l'applicazione di condivisione Microsoft Rights Management
