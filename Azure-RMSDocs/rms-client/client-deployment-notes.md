...
3. **Servizio individuazione di Azure Rights Management**: Il client RMS si connette a **`https://discover.aadrm.com`** , che richiede all'utente di eseguire l'autenticazione.
    ...
    Esempio:  5c6bb73b-1038-4eec-863d-49bded473437.rms.na.aadrm.com/_wmcs/licensing

    *\<YourTenantURL @ no__t-2* ha il formato seguente: **{GUID}. RMS. [Region]. AADRM. com**. È possibile trovare questo valore identificando il valore **RightsManagementServiceId** quando si esegue il cmdlet [Get-AipServiceConfiguration](/powershell/module/aipservice/get-aipserviceconfiguration) .
