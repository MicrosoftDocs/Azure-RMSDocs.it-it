...
- **Per tutti gli altri file**:
    ...
    - Per la versione con disponibilità generale del client: 1 GB
    
    - Per il client di anteprima (versione minima **1.8.41.0**): limitato solo dalla memoria e dallo spazio disponibile su disco
