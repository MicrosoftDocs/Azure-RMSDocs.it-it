...
[mip::AccessDeniedError](class_mip_accessdeniederror.md)  |  L'utente non è riuscito ad accedere al contenuto, ad esempio l'accesso è negato, il contenuto è revocato e così via.
...
[mip::PolicyEngine::Settings](class_mip_policyengine_settings.md)  |  È necessaria un'istanza di questa classe con i parametri appropriati per avviare un motore.
