...
1. Per eseguire i test con Azure RMS, vedere l'articolo [How-to: use ADAL authentication](how-to-use-adal-authentication,md) (Procedura: Usare l'autenticazione ADAL).
