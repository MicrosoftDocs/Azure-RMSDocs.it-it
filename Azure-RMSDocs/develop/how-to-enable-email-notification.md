...
Per configurare la notifica di posta elettronica per una determinata licenza, usare [IpcSetLicenseProperty](/previous-versions/windows/desktop/msipc/ipcsetlicenseproperty) con il parametro di tipo di proprietà *dwPropID* come [IPC \_ li \_ app \_ specific \_ Data](/previous-versions/windows/desktop/msipc/license-property-types) e i campi di dati dell'applicazione formattati come un [ \_ elenco IPC Name \_ \_ value](/previous-versions/windows/desktop/msipc/ipc-name-value-list).
...
- [\_ \_ dati specifici dell'app IPC li \_ \_](/previous-versions/windows/desktop/msipc/license-property-types)
- [IPC \_ \_ \_ elenco di valori di nome](/previous-versions/windows/desktop/msipc/ipc-name-value-list).