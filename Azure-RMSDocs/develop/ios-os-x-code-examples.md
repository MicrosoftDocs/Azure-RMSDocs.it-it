...
-   **Passaggio 3**: Creare una classe [MSMutableProtectedData](https://msdn.microsoft.com/library/dn758325.aspx) e scriverci il contenuto.
...
-   **Passaggio 2**: Creare una classe [MSUserPolicy](https://msdn.microsoft.com/library/dn790796.aspx) personalizzata dal descrittore del criterio, vale a dire *selectedDescriptor*.
