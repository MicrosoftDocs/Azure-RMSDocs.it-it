...
4.  Selezionare la directory da gestire per [!INCLUDE[aad_rightsmanagement_2](../includes/aad_rightsmanagement_2_md.md)], fare clic su **ATTIVA** e quindi confermare l'azione.
    ...
    > [!NOTE]
    > Se questa opzione non è visualizzata, è possibile che il piano di servizio o la versione del prodotto non sia in grado di supportare [!INCLUDE[aad_rightsmanagement_2](../includes/aad_rightsmanagement_2_md.md)].
    >
