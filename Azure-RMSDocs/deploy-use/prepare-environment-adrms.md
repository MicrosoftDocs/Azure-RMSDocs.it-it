...
Se AD RMS viene distribuito per l'organizzazione, considerare se è possibile eseguire la migrazione ad Azure Information Protection. Azure Information Protection presenta numerosi vantaggi rispetto ad AD RMS, ad esempio un supporto migliore per i dispositivi mobili e l'integrazione con i servizi di Office 365, nonché con Exchange Server e SharePoint Server. Per altre informazioni, vedere [Confronto tra Azure Information Protection e AD RMS](../understand-explore/compare-on-premise.md).
...
Per informazioni, vedere la guida alla migrazione: [Migrazione da AD RMS ad Azure Information Protection](../plan-design/migrate-from-ad-rms-to-azure-rms.md)
