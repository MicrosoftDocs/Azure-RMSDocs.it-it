...
description: Informazioni sulle operazioni del ciclo di vita rilevanti se Microsoft gestisce la chiave del tenant per Azure Rights Management (impostazione predefinita).
author: cabailey
manager: mbaldwin
ms.date: 08/25/2016
ms.topic: article
