...
|-------------------------------|---------------------------|-----------------|
|Nome comune: **Modifica contenuto, Modifica** <br /><br />Codifica nei criteri: **DOCEDIT**|Consente di modificare, riorganizzare, formattare o filtrare il contenuto all'interno dell'applicazione. Non concede il diritto di salvare la copia modificata.<br /><br />In Word, questo diritto non è sufficiente per attivare o disattivare **Revisioni** o per usare tutte le funzionalità di rilevamento modifiche come revisore. Per usare tutte le opzioni di rilevamento modifiche, è necessario il diritto seguente: **Controllo completo**. |Diritti personalizzati di Office: come parte delle opzioni **Modifica** e **Controllo completo** <br /><br />Nome nel portale di Azure classico: **Modifica contenuto**<br /><br />Nome nel portale di Azure: **Modifica contenuto, Modifica (DOCEDIT)**<br /><br />Nome nei modelli AD RMS: **Modifica** <br /><br />Valore costante o valore API: non applicabile|
...
|Nome comune: **Visualizza, Apri, Leggi** <br /><br />Codifica nei criteri: **VIEW**|Consente all’utente di aprire il documento e visualizzarne il contenuto.<br /><br /> In Excel questo diritto non è sufficiente per ordinare e filtrare i dati o per creare tabelle pivot. Per queste azioni è necessario il diritto seguente: **Modifica contenuto, Modifica**. [Altre informazioni](https://cloudblogs.microsoft.com/enterprisemobility/2015/12/09/enabling-document-interaction-sort-filter-etc-while-disabling-saving-with-rms/)|Diritti personalizzati di Office: come il diritto personalizzato **Leggi**, opzione **Visualizza**.<br /><br />Nome nel portale di Azure classico: **Visualizza**<br /><br />Nome nel portale di Azure: **Visualizza, Apri, Leggi (VIEW)**<br /><br />Nome nei modelli AD RMS: **Rispondi a tutti** <br /><br />Costante o valore API: `IPC_GENERIC_READ L"VIEW"`|
