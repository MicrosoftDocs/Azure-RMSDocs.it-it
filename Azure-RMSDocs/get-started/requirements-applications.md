...
description: Identificare le applicazioni che offrono supporto nativo per Azure RMS, perfettamente integrato in queste applicazioni grazie alle API RMS, usate per supportare le restrizioni d'utilizzo.
author: cabailey
manager: mbaldwin
ms.date: 08/25/2016
