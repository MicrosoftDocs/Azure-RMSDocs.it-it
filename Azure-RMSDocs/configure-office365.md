...
>
> È anche necessario modificare la variabile `$webUrls` (ad esempio, **https: \//contoso. SharePoint. com**) e la variabile `$listTitle`, ad esempio **$Reports**.
