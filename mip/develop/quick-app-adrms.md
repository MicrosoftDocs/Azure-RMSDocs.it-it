...
ms.locfileid: "69892546"
---
# <a name="quickstart-active-directory-rights-management-server-adfs-protection"></a>Guida introduttiva: Protezione del server AD RMS (Active Directory Rights Management Server)
